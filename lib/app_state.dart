...
class ApplicationState extends ChangeNotifier {
  ...
  StreamSubscription<QuerySnapshot>? _placeSubscription;
  List<Place> _places = [];
  ...
  Future<void> init() async {
    ...
    FirebaseAuth.instance.userChanges().listen((user) {
      if (user != null) {
        ...
        _placeSubscription = FirebaseFirestore.instance
            .collection('places')
            .snapshots()
            .listen((snapshot) {
          _places = [];
          for (final document in snapshot.docs) {
            places.add(
              Place(
                urlimage: document.data()['url'] as String,
                nombre: document.data()['name'] as String,
